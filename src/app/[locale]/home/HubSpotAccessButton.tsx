...
const FORM_ID = "eb7c46e5-c3d2-42c4-8907-a3fcf25dd52e";
const REGION = "na1";
const CONTAINER_ID = "hubspot-access-form-container";

interface HubSpotAccessButtonProps {
  buttonText: string;
}

export default function HubSpotAccessButton({
  buttonText,
}: HubSpotAccessButtonProps) {
